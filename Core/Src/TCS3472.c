...
HAL_StatusTypeDef TCS3472_enable(TCS3472* tcs3472) {
  _TCS3472_write8bitReg(tcs3472, TCS3472_ADDR_ENABLE, TCS3472_REG_ENABLE_PON);
  // HAL_Delay(3);
  _TCS3472_write8bitReg(tcs3472, TCS3472_ADDR_ENABLE, TCS3472_REG_ENABLE_PON | TCS3472_REG_ENABLE_AEN);
  return HAL_OK;
}

HAL_StatusTypeDef TCS3472_disable(TCS3472* tcs3472) {
  uint8_t value;
  _TCS3472_read8bitReg(tcs3472, TCS3472_ADDR_ENABLE, &value);
  value = value & ~(TCS3472_REG_ENABLE_PON | TCS3472_REG_ENABLE_AEN);
  _TCS3472_write8bitReg(tcs3472, TCS3472_ADDR_ENABLE, value);
  return HAL_OK;
}
